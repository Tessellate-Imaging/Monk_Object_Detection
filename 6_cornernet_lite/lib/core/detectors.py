...
class CornerNet(Base):
    def __init__(self, test=False, class_list=[], model_path=None):
        ...
        coco    = COCO(cfg_db, test=test, class_list=class_list)

        cornernet = load_nnet(sys_cfg, model(len(class_list)))
