...
if("512" in model_name):
    x, img = data.transforms.presets.ssd.load_test(img_name, short=512)
else:
    x, img = data.transforms.presets.ssd.load_test(img_name, short=300)

print("Network running the image for prediction")
