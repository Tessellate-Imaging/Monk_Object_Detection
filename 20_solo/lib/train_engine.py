...
class Detector():
    ...
    def List_Models(self):
        self.system_dict["params"]["model_list"] = ["solo_resnet50", "solo_resnet101",
                                                    ...
                                                    "solov2_resnet101_dcn", "solov2_rexnext101_dcn",
                                                    "solov2_lite_resnet18", "solov2_lite_resnet34",
    ...
    def Model_Params(self, model_name="solo_resnet50", gpu_devices=[0], launcher="none"):
        ...
        if(model_name == "solo_resnet50"):
            ...
            if(not os.path.isfile("solo_resnet101_pretrained.pth")):
                ...
                os.system("wget https://cloudstor.aarnet.edu.au/plus/s/WxOFQzHhhKQGxDG/download -O solo_resnet101_pretrained.pth")
                print("Done...");
        elif(model_name == "decoupled_solo_resnet50"):
            if(not os.path.isfile("decoupled_solo_resnet50_pretrained.pth")):
                print("Downloading Model (Takes around 30 mins) ...");
                os.system("wget https://cloudstor.aarnet.edu.au/plus/s/dXz11J672ax0Z1Q/download -O decoupled_solo_resnet50_pretrained.pth")
                print("Done...");
        elif(model_name == "decoupled_solo_resnet101"):
            if(not os.path.isfile("decoupled_solo_resnet101_pretrained.pth")):
                print("Downloading Model (Takes around 30 mins) ...");
            ...
            if(not os.path.isfile("solov2_resnet101_pretrained.pth")):
                ...
                print("Done...");
        elif(model_name == "solov2_resnet101_dcn"):
            if(not os.path.isfile("solov2_resnet101_dcn_pretrained.pth")):
                print("Downloading Model (Takes around 20 mins) ...");
                os.system("wget https://cloudstor.aarnet.edu.au/plus/s/4ePTr9mQeOpw0RZ/download -O solov2_resnet101_dcn_pretrained.pth")
                print("Done...");
        elif(model_name == "solov2_rexnext101_dcn"):
            if(not os.path.isfile("solov2_rexnext101_dcn_pretrained.pth")):
                print("Downloading Model (Takes around 20 mins) ...");
                os.system("wget https://cloudstor.aarnet.edu.au/plus/s/KV9PevGeV8r4Tzj/download -O solov2_rexnext101_dcn_pretrained.pth")
                print("Done...");
        elif(model_name == "solov2_lite_resnet18"):
            if(not os.path.isfile("solov2_lite_resnet18_pretrained.pth")):
                print("Downloading Model (Takes around 20 mins) ...");
                os.system("wget https://cloudstor.aarnet.edu.au/plus/s/HwHys05haPvNyAY/download -O solov2_lite_resnet18_pretrained.pth")
                print("Done...");
        elif(model_name == "solov2_lite_resnet34"):
            if(not os.path.isfile("solov2_lite_resnet34_pretrained.pth")):
                print("Downloading Model (Takes around 20 mins) ...");
                os.system("wget https://cloudstor.aarnet.edu.au/plus/s/QLQpXg9ny7sNA6X/download -O solov2_lite_resnet34_pretrained.pth")
                print("Done...");
        elif(model_name == "solov2_lite_resnet50"):
            if(not os.path.isfile("solov2_lite_resnet50_pretrained.pth")):
                print("Downloading Model (Takes around 20 mins) ...");
                os.system("wget https://cloudstor.aarnet.edu.au/plus/s/cn1jABtVJwsbb2G/download -O solov2_lite_resnet50_pretrained.pth")
                print("Done...");
    ...
    def update_config(self):
        if(self.system_dict["local"]["model_name"] == "solo_resnet50"):
            ...
            f.write(lines);
            f.close();  
        elif(self.system_dict["local"]["model_name"] == "decoupled_solo_resnet101"):
            f = open("Monk_Object_Detection/20_solo/lib/configs_base/decoupled_solo_resnet101.py");
            lines = f.read();
            f.close();
            ...
            f.write(lines);
            f.close();
        elif(self.system_dict["local"]["model_name"] == "decoupled_solo_lite_resnet50"):
            f = open("Monk_Object_Detection/20_solo/lib/configs_base/decoupled_solo_lite_resnet50.py");
            lines = f.read();
            f.close();
            ...
            f.write(lines);
            f.close();  
        elif(self.system_dict["local"]["model_name"] == "decoupled_solo_lite_resnet50_dcn"):
            f = open("Monk_Object_Detection/20_solo/lib/configs_base/decoupled_solo_lite_resnet50_dcn.py");
            lines = f.read();
            f.close();
            ...
            f.write(lines);
            f.close();  
        elif(self.system_dict["local"]["model_name"] == "solov2_resnet101_dcn"):
            f = open("Monk_Object_Detection/20_solo/lib/configs_base/solov2_resnet101_dcn.py");
            lines = f.read();
            f.close();
            ...
            f.write(lines);
            f.close();
        elif(self.system_dict["local"]["model_name"] == "solov2_rexnext101_dcn"):
            f = open("Monk_Object_Detection/20_solo/lib/configs_base/solov2_rexnext101_dcn.py");
            lines = f.read();
            f.close();
            ...
            f.write(lines);
            f.close();
        elif(self.system_dict["local"]["model_name"] == "solov2_lite_resnet18"):
            f = open("Monk_Object_Detection/20_solo/lib/configs_base/solov2_lite_resnet18.py");
            lines = f.read();
            f.close();
            ...
            f.write(lines);
            f.close();
        elif(self.system_dict["local"]["model_name"] == "solov2_lite_resnet34"):
            f = open("Monk_Object_Detection/20_solo/lib/configs_base/solov2_lite_resnet34.py");
            lines = f.read();
            f.close();
            ...
            f.write(lines);
            f.close();
        elif(self.system_dict["local"]["model_name"] == "solov2_lite_resnet50"):
            f = open("Monk_Object_Detection/20_solo/lib/configs_base/solov2_lite_resnet50.py");
            lines = f.read();
            f.close();
    ...
    def Train(self):
        ...
        os.system("cp config_updated.py work_dirs/" + self.system_dict["local"]["model_name"] + "/");
